...
#endif
#if !defined(GUBG_PLATFORM_COMPILER_VERSION)
    #error GUBG_PLATFORM_COMPILER_VERSION define not set
#endif
#if !defined(GUBG_PLATFORM_DEBUG)
    #error GUBG_PLATFORM_DEBUG define not set
#endif
#if !GUBG_PLATFORM_COMPILER_GCC && !GUBG_PLATFORM_COMPILER_MSVC
...
#if 0
    #if !defined(GUBG_PLATFORM_BITS)
        #error GUBG_PLATFORM_BITS is not available
    #endif
    #if !defined(GUBG_PLATFORM_ARCH)
